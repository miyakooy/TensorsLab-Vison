...
범용 image-to-image API를 통해 얼굴 교체를 시도할 수는 있지만 전용 `faceswap`, `face-swap`, 마스크, 신원 일관성 또는 Deepfake 파이프라인은 없습니다. 결과는 최선 노력 방식으로 모두 검토해야 하며, 사용 권한과 당사자 동의를 확보한 미디어만 사용해야 합니다.
